 ...
 */
package com.raven.swing.notification;
...
public class Notification extends javax.swing.JPanel {
    ...
    private void init(String message) {
        ...
        cmdClose.setCursor(new Cursor(Cursor.HAND_CURSOR));
        ...
        if (type == Type.SUCCESS) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/swing/notification/sucess.png")));
            lbMessage.setText("Thành công");
            color = Color.GREEN;
        } else if (type == Type.INFO) {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/swing/notification/info.png")));
            color = Color.BLUE;
            lbMessage.setText("Thông tin");
        } else {
            lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/swing/notification/warning.png")));
            color = Color.ORANGE;
    ...
    private void initComponents() {
        ...
        lbIcon.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/swing/notification/sucess.png"))); // NOI18N
        ...
        cmdClose.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/swing/notification/close.png"))); // NOI18N
