 ...
 * @author DELL
 */
public class CellNgayHenTra extends TableCustomCell {

    private TheMuon tm;

    public CellNgayHenTra() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tf_id5, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
                .addContainerGap())
            .addComponent(tf_id4)
        );
    ...
    public void setData(Object o) {
        tf_id1.setText(o.toString());
        tf_id2.setText(o.toString());
        tf_id3.setText(o.toString());
        tf_id4.setText(o.toString());
        tf_id5.setText(o.toString());
    }
    ...
    public TableCustomCell createComponentCellEditor(TableCustom tc, TableRowData trd, Object o, int i, int i1) {
        CellNgayHenTra ctm = new CellNgayHenTra();
        ctm.setData(o);
        return ctm;
    }
