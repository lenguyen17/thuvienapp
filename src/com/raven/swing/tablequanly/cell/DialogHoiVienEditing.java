...
public class DialogHoiVienEditing extends javax.swing.JDialog {

    private final Animator animator;
    private boolean show = true;

    public DialogHoiVienEditing(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        lbIcon.setIcon(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")));
    ...
    public void showEdit(String idHoiVien) {
        SwingWorker<Integer, Void> worker = new SwingWorker<Integer, Void>() {
            @Override
            protected Integer doInBackground() throws Exception {
                HoiVien hv = HoiVienDAO.getInstance().selectByID(idHoiVien);
                if (hv != null) {
                    textField_hoTen.setText(hv.getHoTen());
                    textField_MSHV.setText(hv.getIdHoiVien());
                    textField_MSSV.setText(hv.getMaSV());
    ...
    private void initComponents() {
        ...
        textField_MSHV.setEditable(false);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbMessage9, javax.swing.GroupLayout.DEFAULT_SIZE, 110, Short.MAX_VALUE)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                        .addComponent(lbChuaTra, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(lbSachDaMuon, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        if (kiemTraNhapLieu()) {
            try {
                ...
                if (newHV != null) {
                    HoiVienDAO.getInstance().update(newHV);
                }
                ...
                Notification noti = new Notification(fram, Notification.Type.WARNING, Notification.Location.TOP_CENTER, "Cập nhật không thành công!");
                noti.showNotification();
            }
            closeMenu();
        } else {
