...
//        }
    ...
    private void createHintText(Graphics2D g2) {
        ...
        double textX = (width - r2.getWidth()) / 2;
        double size;
        if (animateHinText) {
            if (show) {
                size = 12 * (1 - location);
        ...
        g2.drawString(labelText,(int) (textX + in.right +ft.getAscent()*2), (int) (in.top + textY + ft.getAscent() - size));
...
//            g2.fillRect(2,(int)(y-5),2 ,(int) size);
