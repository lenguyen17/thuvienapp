package com.raven.component.chart.piechart;
...
public class PieChart extends JComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < models.size(); i++) {
            ...
            if (hoverIndex == i) {
                ...
                String detail = "     " + format.format(data.getValues()) ;
    ...
    private void drawPopupLabel(Graphics2D g2, double size, double angle, double labelX, double labelY, String text, String detail) {
        ...
        RoundRectangle2D rec = new RoundRectangle2D.Double(recX, recY, width+15, height, 5, 5);
        g2.fill(rec);
        g2.setColor(new Color(235, 235, 235));
        g2.draw(rec);
        g2.setColor(getForeground());
        recX += paceH;
        g2.setFont(getFont().deriveFont(Font.PLAIN, fontSize+4));
        g2.drawString(text, (float) recX, (float) (recY + fm1.getAscent() + spaceV));
        g2.setFont(getFont().deriveFont(Font.PLAIN, fontSize+2));
