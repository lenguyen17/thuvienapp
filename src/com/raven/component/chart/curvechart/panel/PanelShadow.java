package com.raven.component.chart.curvechart.panel;

import com.raven.component.chart.curvechart.shadow.ShadowRenderer;
...
public class PanelShadow extends JPanel {
    ...
    private Color colorGradient = new Color(50, 50, 50);
    private int radius;
