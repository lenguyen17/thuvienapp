package com.raven.component.chart.curvechart;

import com.raven.component.chart.curvechart.chart.ModelLegend;
...
import com.raven.component.chart.curvechart.chart.LegendItem;
import com.raven.component.chart.curvechart.chart.ModelChart;
import com.raven.component.chart.curvechart.chart.blankchart.BlankPlotChart;
import com.raven.component.chart.curvechart.chart.blankchart.BlankPlotChatRender;
...
public class CurveLineChart extends JComponent {
    ...
    public void removeAllLegend() {
        for (Component com : panelLegend.getComponents()) {
            if (com instanceof LegendItem) {
                panelLegend.remove(com);
            }
        }
    }
