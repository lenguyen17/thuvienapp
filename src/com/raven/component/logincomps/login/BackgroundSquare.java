...
import com.raven.component.logincomps.border.FancyBorderRadius;
import com.raven.component.logincomps.shadow.ShadowRenderer;
...
public class BackgroundSquare extends JComponent {
    ...
    public BackgroundSquare() {
        image = new ImageIcon(getClass().getResource("/com//raven/component/logincomps/login/bg_dark.jpg"));
    }
    ...
    private void createBlurImage(Graphics2D g) {
        ...
        if (width > 0 && height > 0) {
            ...
            Shape shape = new FancyBorderRadius(width, height, "100% 0% 100% 0% / 0% 100% 0% 100%").getShape();
            g2.fill(shape);
